...
model = keras.models.load_model(r'C:\Users\yener\OneDrive\Desktop\Datasets with compleated analysis and predictions\GitHub_Banknote_Authentication\bank_model')

## load the copy of the dataset
df = pd.read_csv(r'C:\Users\yener\OneDrive\Desktop\Datasets with compleated analysis and predictions\GitHub_Banknote_Authentication\data_banknote_authentication.csv')
...
## add image
image = Image.open(r"C:\Users\yener\OneDrive\Desktop\Datasets with compleated analysis and predictions\GitHub_Banknote_Authentication\983.jpg")
